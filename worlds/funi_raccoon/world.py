...
from . import options as FuniRaccoon_options  # rename due to a name conflict with World.options

# FuniRaccoon will go through all the parts of the world api one step at a time,
...
class FuniRaccoonWorld(World):
    """
    FuniRaccoon is a minimal 8bit-era inspired adventure game with grid-like movement.
    ...
    # (Note: options.py has been imported as "FuniRaccoon_options" at the top of this file to avoid a name conflict)
    options_dataclass = FuniRaccoon_options.FuniRaccoonOptions
    options: FuniRaccoon_options.FuniRaccoonOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
