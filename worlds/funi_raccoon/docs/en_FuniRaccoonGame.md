...
Funi Raccoon Game is a silly 3D collectathon about a Raccoon stealing things and causing havoc around the world.

## What does randomization do to this game?

- All collectible types, including: Jewels, Cats, Hats, Mystical Dumbbells, Euros (if enabled) and purchaseable upgrades for the Kei Truck are randomized and send checks.
...
All Dumpster items, hats, jewels, cats, dumbbell increases, and progressive cooling rods can be found, as well as filler euro increases.
